...
//hello를 호출해서 쓸 수 없음. 변수 이름을 넣어서 실행해야 함. 함수의 이름만 정의가 된 것. 많이 사용되지는 않음
...
callbackFunctionExpression(
  "https://www.naver.com",
  function (url) {
    //여기있는 함수가 실행됨. 함수는 값이기 때문에 어디든지 보낼 수 있음
...
//요즘 잘 안 씀. 전역을 보호해주기 위해 사용했다.
//var는 전역을 오염시킴. 오염시키지 않는 방법 => 함수 안에 사용하기 => 사용할 때마다 함수 만들기 번거롭다 => 즉시실행함수
