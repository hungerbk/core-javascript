...
// - 재귀 단계(step) : 재귀 시에 반복적으로 처리할 일 (공통적인 처리)
...
// 성능은 반복문이 더 좋지만, 가독성은 재귀함수가 더 좋음. 가독성이 좋으면(보기 편하면) 유지보수가 편함
...
const memoFibo = (n) => {
  ...
  if (memoFibo.cache[n]) {
    ...
    //한번이라도 계산된 값은 저장이 되기 때문에 또 계산을 할 필요가 없음
    //저장된 것을 꺼내쓰기 때문!
  }
};
memoFibo.cache = {};
